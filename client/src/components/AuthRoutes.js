        ...
        >
          {(() => {
            switch (window.location.pathname) {
              ...
              case "/tasks":
                return <Route exact path="/tasks" component={NewTasksPage} />;
              case "/projects":
                return <Route exact path="/projects" component={ProjectsPage} />;
              case "/team/:teamId/project/:projectId/:projectName":
                return (
                  <Route
              ...
              case "/team/:teamId/:teamName":
                return <Route path="/team/:teamId/:teamName" component={TeamPage} />;
              default:
